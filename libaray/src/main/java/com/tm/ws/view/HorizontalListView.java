...
public class HorizontalListView extends AdapterView<ListAdapter> {
   ...
   /* public void setOnScrollLeftListener(OnScrollLeftListener listener) {
    ...
    public void setSelection(int position) {
        ...
        if (position != mCurrentX) {
            setOriginalColor(mCurrentX);
        }
        mCurrentX = position;
        setSelectColor(mCurrentX);
        // TODO: implement
    }

    /**
     * author ws
     * created 2017/11/29 10:39
     */
    //设置原来色
    private void setOriginalColor(int mCurrentX) {
        View child = getChildAt(mCurrentX);
        Button button = (Button) child.findViewById(R.id.btn_horizontal_scroll);
